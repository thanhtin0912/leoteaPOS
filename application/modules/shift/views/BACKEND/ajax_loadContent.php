		...
		<table class="table table-striped table-bordered table-hover dataTable no-footer">
			<thead>
				<tr role="row">
					...
					<th class="sorting">Tên Nhân Viên</th>
					<th class="sorting">Vào ca</th>
					<th class="sorting">Kết ca</th>
					<th class="sorting">Tài khoản</th>
					<th class="sorting">Cửa hàng</th>
			...
			<tbody>
				...
				<tr class="item_row<?=$i?> gradeX <?php ($k%2==0) ? print 'odd' : print 'even' ?>" role="row">
					...
					<td><a href="<?=PATH_URL_ADMIN.$module.'/update/'.$v->id?>"><?= $v->user; ?></a></td>
