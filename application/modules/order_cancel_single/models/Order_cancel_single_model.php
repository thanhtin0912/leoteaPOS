<?php
class Order_cancel_single_model extends CI_Model {
	private $module = 'order_cancel_single';
	private $table = 'order_cancel_single';
	...
	function getsearchContent($limit,$page){
		...
		if($this->input->post('username')!=''){
			$this->db->where('n.name', $this->input->post('username'));
		}
		...
		$this->db->join(PREFIX.$this->table_store." s", 'n.store = s.id', "left");
		$query = $this->db->get();
	...
	function getDetailManagement($id){
		...
		$this->db->join(PREFIX.$this->table_store." s", 'o.store = s.id', "left");
		$query = $this->db->get();
