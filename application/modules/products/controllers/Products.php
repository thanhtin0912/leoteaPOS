...
class Products extends MX_Controller {
	...
	public function admincp_update($id=0){
		...
		$this->load->model('toppings/toppings_model');
		$this->load->model('productSize/productSize_model');
		if($id==0){
		...
		$data = array(
			...
			'toppings'=>$this->toppings_model->getData(),
			'cate_toppings'=>$this->categories_topping_model->getData(),
			'productSize'=>$this->productSize_model->getData(),
			'result'=>$result[0],
			'module'=>$this->module,
			'id'=>$id
		);
