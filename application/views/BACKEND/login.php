                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active">
                                        ...
                                        <div class="form-group">
                                            <input onkeypress="return EnterLogin(event)" required="" type="text"
                                                class="form-control" placeholder="Username" id="loginUser">
                                        </div>
                                        <div class="form-group">
                                            <input onkeypress="return EnterLogin(event)" required="" type="password"
                                                class="form-control" placeholder="Password" id="loginPass">
                                        </div>
